                ...
                <div className="container">
                    <div className="container mt-4 mb-4">
                        ...
                        <p className="description">
                            Khám phá bộ sưu tập thú nhồi bông và gấu bông của Bemori. Shop gấu
                            bông chính hãng chất lượng, gần nhà bạn. Đặt hàng ngay hôm nay để
                    ...
                    <div className="row d-flex justify-content-center">
                        {/* Truyền category="Thú Bông" và selectedPriceRange giống như BlindboxPage */}
                        <ProductList category="3" selectedPriceRange={selectedPriceRange} />
                    </div>
                </div>
...
export default memo(ThuBongPage);
