      ...
      <main>
        <div className="container">
          <div className="container mt-4 mb-4">
            ...
            <div className="filter-group d-flex align-items-center">
              ...
              <div className="dropdown ms-2">
                <button className="btn btn-outline-pink dropdown-toggle" type="button" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Khoảng Giá
                </button>
          ...
          <div className="row d-flex justify-content-center">
            {/* Truyền category="Blindbox" và selectedPriceRange để lọc bên trong ProductList */}
            <ProductList category="1" selectedPriceRange={selectedPriceRange} />
          </div>
        </div>
...
export default memo(BlindBoxPage);
